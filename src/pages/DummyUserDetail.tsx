...
const DetailItem = ({ label, value, icon: Icon }: any) => (
  <div className="flex items-center gap-4 p-4 rounded-[1.25rem] bg-white dark:bg-gray-800/40 border border-pink-100/50 dark:border-gray-700/30 group/item hover:border-pink-300 dark:hover:border-pink-500/30 transition-all duration-300">
    ...
    <div className="flex-1 min-w-0">
      ...
      <p className="text-[13px] font-bold text-gray-900 dark:text-gray-100 break-words leading-relaxed">{value}</p>
    </div>
  </div>
)
              ...
              <div className="space-y-8 animate-fade-in">
                  ...
                  <div className="mt-8 grid sm:grid-cols-2 gap-4">
                    ...
                    <InnerCard className="p-5 flex items-center justify-between group flex-wrap">
                      <div className="min-w-0">
                        ...
                        <p className="text-sm font-black text-gray-900 dark:text-gray-100 break-words">{user.kycDocs.nameOnCard || user.name}</p>
                      </div>
                    </InnerCard>
                  </div>
                </Card>
                ...
                <Card className="p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    <DetailItem label="Accommodation" value="Rented Apartment" icon={() => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>} />
                  </div>
                </Card>
              </div>
            )}
