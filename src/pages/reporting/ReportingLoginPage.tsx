...
import { reportingLogin } from "@/lib/reportingApi";
import { useReportingAuthStore } from "@/store/reportingAuth.store";

const ReportingLoginPage = () => {
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Reporting Portal</h1>
        ...
        <Card>
          <form onSubmit={handleSubmit}>
            <CardHeader>
              ...
              <CardDescription>Enter your credentials to access reports</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/reporting/forgot-password" className="text-sm text-primary hover:underline">
                    Forgot password?
                  </Link>
                </div>
...
export default ReportingLoginPage;
